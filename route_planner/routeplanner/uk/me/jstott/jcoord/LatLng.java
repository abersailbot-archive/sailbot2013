package routeplanner.uk.me.jstott.jcoord;
...
public class LatLng {
  ...
  public String toString() {
      ...
      String latString = new Double(this.lat).toString();
      String lonString = new Double(this.lng).toString();
  ...
  {
      LatLng ll = (LatLng) o;
      if(ll.getLat()==getLat()&&ll.getLng()==getLng())
      {
          return true;
      }
      return false;
